...
public class GameTextCatalogTests
{
    ...
    private static readonly IReadOnlyDictionary<string, string> RequiredKeyConstants = new Dictionary<string, string>
    {
        ...
        ["Common.Enter"] = "common.enter",
        ["Common.Leave"] = "common.leave",
        ["Common.Paste"] = "common.paste",
        ...
        ["Party.ConfirmFilter"] = "party.confirm_filter",
        ["Party.ConfigurationUnavailable"] = "party.configuration_unavailable",
        ["Party.ElementalResonance"] = "party.elemental_resonance",
        ["Party.Configuration"] = "party.configuration",
        ["Party.Remove"] = "party.remove",
        ["Party.Friendship"] = "party.friendship",
        ["Party.Replace"] = "party.replace",
        ["Party.Join"] = "party.join",
        ["Party.Order"] = "party.order",
        ["Redemption.Account"] = "redemption.account",
        ["Redemption.GoToRedeem"] = "redemption.go_to_redeem",
        ["Redemption.RedeemReward"] = "redemption.redeem_reward",
        ["Redemption.Success"] = "redemption.success",
        ...
        ["LeyLine.DoubleReward"] = "ley_line.double_reward",
        ["LeyLine.DoubleReward2x"] = "ley_line.double_reward_2x",
        ["LeyLine.Touch"] = "ley_line.touch",
        ["LeyLine.Activate"] = "ley_line.activate",
        ["LeyLine.Select"] = "ley_line.select",
        ["LeyLine.Line"] = "ley_line.line",
        ["LeyLine.Outcrop"] = "ley_line.outcrop",
        ["LeyLine.BlossomOfWealth"] = "ley_line.blossom_of_wealth",
        ["LeyLine.BlossomOfRevelation"] = "ley_line.blossom_of_revelation",
        ["LeyLine.Stop"] = "ley_line.stop",
        ["LeyLine.OriginalResin40Prompt"] = "ley_line.original_resin_40_prompt",
        ["LeyLine.FightSuccess"] = "ley_line.fight_success",
        ["LeyLine.FightFailure"] = "ley_line.fight_failure",
        ["LeyLine.FightObjective"] = "ley_line.fight_objective",
        ["LeyLine.FightObjective"] = "ley_line.fight_objective",
        ["Stygian.Return"] = "stygian.return",
        ["Stygian.ChallengeFailed"] = "stygian.challenge_failed",
        ["Stygian.RetryChallenge"] = "stygian.retry_challenge",
        ["Stygian.LeyLineBlossom"] = "stygian.ley_line_blossom",
        ["Stygian.CharacterPreview"] = "stygian.character_preview",
        ["Stygian.EventName"] = "stygian.event_name",
        ["Stygian.EventOverview"] = "stygian.event_overview",
        ["Stygian.RewardPhase"] = "stygian.reward_phase",
        ["Stygian.PhaseEnded"] = "stygian.phase_ended",
        ["Stygian.GoToChallenge"] = "stygian.go_to_challenge",
        ["Stygian.HardDifficulty"] = "stygian.hard_difficulty",
        ["Stygian.UltimateChallenge"] = "stygian.ultimate_challenge",
        ["Stygian.NormalChallenge"] = "stygian.normal_challenge",
        ["Stygian.PresetTeams"] = "stygian.preset_teams",
        ["Expedition.Entry"] = "expedition.entry",
        ["Expedition.TimeShortened"] = "expedition.time_shortened",
        ["Expedition.RewardsIncreased"] = "expedition.rewards_increased",
        ["Expedition.NoBonus"] = "expedition.no_bonus",
        ["Expedition.Complete"] = "expedition.complete",
        ["Expedition.InProgress"] = "expedition.in_progress",
        ["Expedition.Rewards"] = "expedition.rewards",
        ["Expedition.SelectCharacter"] = "expedition.select_character",
        ["Expedition.CharacterSelection"] = "expedition.character_selection",
